...
$rows = $connection -> query('SELECT * FROM PSUs');
        ...
        foreach( $rows as $row ) {
            ...
            <div class = "contain">
                <div class="container1">
                    <a href="ind_psu.php?id=<?= $row['PSUid'] ?>" style="text-decoration: none; color: black" >

                        <img alt src="images\Products\PSU\<?= $row['PSUid'] ?>.jpg" class="containPicture"><br>
                        <div class="row">
