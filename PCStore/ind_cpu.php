...
$id = $_GET['id'];
$obj = $connection->prepare('SELECT * FROM CPUs WHERE CPUid = ?');
$obj->execute([$id]);
$itm = $obj->fetch();
            ...
            <h1 class="mb-0" style="max-font-size: 600px; color: black;">
                ...
                <div class="row">
                    <div class="col" class="previewPic" style="width:100%; max-width: 350;">
                        <img src="images\Products\CPU\<?= $itm['CPUid'] ?>.jpg" class="previewPic">
                    </div>
                    ...
                    <div class="col-md" style="background-color: #3498db; border-radius: 10px; padding: 10px;">
                        ...
                        <div class="row">
                            <h6 class="mb-0"style="font-size: 30px;">
                                Core Count: <?= $itm['CoreCount'] ?>
                            </h6>
                        </div>

                        <div class="row">
                            <h6 class="mb-0" style="font-size: 30px;">
                                Thread Count: <?= $itm['ThreadCount'] ?>
                            </h6>
                        </div>

                        <div class="row">
                            <h6 class="mb-0" style="font-size: 30px;">
                                Base Frequency: <?= $itm['BaseFrequency'] ?> GHz
                            </h6>
                        </div>

                        <div class="row">
                            <h6 class="mb-0" style="font-size: 30px;">
                                Boost Frequency: <?= $itm['BoostFrequency'] ?> GHz
                            </h6>
                        </div>
