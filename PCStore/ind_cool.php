...
$id = $_GET['id'];
$obj = $connection->prepare('SELECT * FROM Cooling WHERE CoolingID = ?');
$obj->execute([$id]);
$itm = $obj->fetch();
            ...
            <h1 class="mb-0" style="max-font-size: 600px; color: black;">
                ...
                <div class="row">
                    <div class="col" class="previewPic" style="width:100%; max-width: 350;">
                        <img src="images\Products\Cooling\<?= $itm['CoolingID'] ?>.jpg" class="previewPic">
                    </div>
                    ...
                    <div class="col-md" style="background-color: #3498db; border-radius: 10px; padding: 10px;">
                        ...
                        <div class="row">
                            <h6 class="mb-0" style="font-size: 30px;">
                                Fan Size: <?= $itm['FanSize'] ?> mm
                            </h6>
                        </div>

                        <div class="row">
                            <h6 class="mb-0" style="font-size: 30px;">
                                Fan Speed: <?= $itm['FanSpeed'] ?> rpm
                            </h6>
                        </div>

                        <div class="row">
                            <h6 class="mb-0" style="font-size: 30px;">
                                Fan Noise: <?= $itm['FanNoise'] ?> dB
                            </h6><br><br><br
